...
let UserController = (() => {
    let _classDecorators = [(0, inversify_express_utils_1.controller)("/users")];
    ...
    var UserController = _classThis = class {
        constructor(userUseCase) {
            this.userUseCase = (__runInitializers(this, _instanceExtraInitializers), userUseCase);
        }
        getUsers(_, res) {
    ...
    (() => {
        ...
        _getUsers_decorators = [(0, inversify_express_utils_1.httpGet)("/")];
